...
- **Thermometer** (any standard Bluetooth thermometer, not tied to one brand) — [health-thermometer-ble](https://github.com/home-health-hub/health-thermometer-ble) *(work in progress, not yet tested against real hardware)*
